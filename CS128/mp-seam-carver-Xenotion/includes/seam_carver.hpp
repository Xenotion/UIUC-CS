...
public:
  ...
  void RowIsZero(int& col, int& row, int& leftr, int& leftg, int& leftb, int& rightr, int& rightg, int& rightb) const;
  void RowIsLast(int& col, int&row, int& leftr, int& leftg, int& leftb, int& rightr, int& rightg, int& rightb) const;
  void RowIsMiddle(int& col, int&row, int& leftr, int& leftg, int& leftb, int& rightr, int& rightg, int& rightb) const;
  void HelperHorizontal(int* seam, int& min_index, int** arr) const;
  void HelperVertical(int* seam, int& minindex, int** arr) const;
